...
Relational Databases manage the databases and SQL is the language use to manage the query database.

- [ ] Why do tables need a `primary key`?

To avoid confusion or duplication while accessing rows independently with unique id's.
...
A table in addition related to the foreign key that reference to the primary keys of the original table.
